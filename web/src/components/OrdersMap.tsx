...
function OrdersMap({
  ...
  useEffect(() => {
    ...
    } else if (pickupCoords && dropoffCoords && !driverView) {
      // Form preview or dispatcher: route without polyline — draw simple line. Driver: skip so we don't show wrong straight line; /geo/route will provide road polyline.
      const latLngs = [
